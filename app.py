...
def ask_gemini_for_structured_prompt(prompt_instruction, generation_config=None, max_output_tokens=1028):
    try:
...
async def generate_prompts_async(raw_input, language_code="en-US", prompt_mode='text', category=None, subcategory=None, persona=None): # NEW: Added persona parameter
    ...
    if prompt_mode == 'image_gen':
        ...
        main_prompt_result = await asyncio.to_thread(ask_gemini_for_text_prompt, base_instruction, max_output_tokens=1028)
...
async def generate_reverse_prompt_async(input_text, language_code="en-US", prompt_mode='text'):
    ...
    reverse_prompt_result = await asyncio.to_thread(ask_gemini_for_text_prompt, prompt_instruction, max_output_tokens=1028)
...
async def test_llm_response(): # CHANGED to async def
    ...
    try:
        ...
        llm_response_text_raw = await asyncio.to_thread(ask_gemini_for_text_prompt, llm_instruction, max_output_tokens=1028)
